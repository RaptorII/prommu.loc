var YiiChat = function(options){
	...
	var add = function(post){
		...
		p.find('.track').html("<div class='owner'><img src='"
			 + post.owner_photo + "'><span>" + post.owner + "</span>, "
			 + "<span class='time'>" + post.time + "</span></div>");
	...
	you.html("<div id='yiichat_area_panel'></div><textarea id='yiichat_area'></textarea><div class='exceded'></div><br/>");	
