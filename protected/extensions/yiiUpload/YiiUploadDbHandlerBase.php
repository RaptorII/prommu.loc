 ...
 *							only when we are creating a post: yiiupload_post
 *
 ...
 * @license FREE BSD
 */
abstract class YiiUploadDbHandlerBase extends CComponent implements IYiiUpload {
	...
	public function yiiupload_post($chat_id, $identity, $message, $data){
		...
		if($message_filtered != ""){
			$obj = array(
				...
				"owner"=>substr($this->getIdentityName(),0,50),
				"created"=>time(),
