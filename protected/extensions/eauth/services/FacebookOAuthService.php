...
class FacebookOAuthService extends EOAuth2Service {
	...
	protected function fetchAttributes() {
		$info = (object)$this->makeSignedRequest('https://graph.facebook.com/v3.3/me', array(
			'query' => array(
				'fields' => join(',', array(
					'id',
					'name',
		...
		$this->attributes['fname'] = $info->first_name;
		$this->attributes['email'] = $info->email;
		$this->attributes['lname'] = $info->last_name;
		$this->attributes['birthday'] = $info->birthday;
		$this->attributes['gender'] = $info->gender;
		$id = $info->id;
		$this->attributes['photo'] = "https://graph.facebook.com/$id/picture?height=400&width=400";
	}
