  ...
  */
  ...
  <div class='col-xs-12 col-sm-8 col-lg-9 ppe__content'>
    <h2 class="upp__title"><?=$viData['userInfo']['name']?></h2>
      ...
      //js
      Yii::app()->getClientScript()->registerScriptFile(MainConfig::$JS . 'register/complete-reg.js', CClientScript::POS_END);
              ...
              <form id="complete__form">
                  <div class="complete__wrap">
                      ...
                      <div class="complete__cover complete__company">
                          ...
                          <div class="complete__phone" id="phone-code">
                              <input type="text" required="">
                              <input type="hidden" name="__phone_prefix" value="7">
                              <span class="highlight"></span>
                              <span class="bar"></span>
                              <label >Телефон</label>
                          </div>
                      ...
                      <div class="complete__prof">
                          ...
                          <ul id="complete__prof-list" class="complete__prof-list">
                              ...
                              foreach($viData['userAllInfo']['cotype'] as $cotype){
                                  ?>
                                  <li>
                                      <input type="radio" name="donjnost[]" value="<?=$cotype['id']?>" id="post-<?=$cotype['id']?>" class="complete__prof-item">
                                      <label for="post-<?=$cotype['id']?>" class="prof-item"> <?= $cotype['name'] ?> <b></b></label>
                                  </li>
