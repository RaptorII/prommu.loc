      ...
      <div class="reviews-applicant-item">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-9">
            <form action="" method="post" id="form_rating"> 
              ...
              <div class="rai__b-tab enable">
                <div class="rai__b-subtitle">добавить Рейтинг</div>
                <div class="rai__b-tab-content" style="display:block">
                  <table class="rai__table">
                    <tbody> 
                      <? foreach ($viData['pointRate'] as $key => $val): ?>
                        <tr>
              ...
              <div class="rai__b-tab">
                <div class="rai__b-subtitle">Отзыв</div>
                <div class="rai__b-tab-content">
              ...
              <br>
              <div class="center">
                <button type="submit" class="prmu-btn prmu-btn_normal" id="send_rating">
                  <span>СОХРАНИТЬ</span>
                </button>
              </div>
