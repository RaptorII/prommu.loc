<div class='row'>
    <form action="/vacancy" id="F1Filter" method="get">
...
<!--            <h3>Фильтр</h3>-->
            ...
            <div class='filter-label filter-age'>
             ...
             <div class='filter-label filter-smart'>
                ...
                <div class='filter-content opened'>
                    <div class='radio-box right-box'>
                        <label class='checkbox-box' for='ChkSmart'>
                <b>Наличие смартфона</b>
                <input id='ChkSmart' name='smart' value='1' type='checkbox' <?= Yii::app()->getRequest()->getParam('smart') ? 'checked' : '' ?>>
                <span></span>
              </label>
                        <br>
                        <br>
    ...
    <div class='col-xs-12 col-sm-8 col-md-9'>
        <?php if($this->ViewModel->getViewData()->pageH1): ?>
            <h1 class="main-h1"><?php echo $this->ViewModel->getViewData()->pageH1; ?></h1>
        <?php endif; ?>

        <!-- <?php if($this->ViewModel->getViewData()->pageText): ?> -->
                                ...
                                <div class='row'>
                                    <div class='col-xs-12'>
                                        <div class='btn-go-vacancy-02 btn-white-green-wr'>
                                            <a href='/vacancy/<?= $val['id'] ?>'>Подробнее</a>
                                        </div>
                                    </div>
                                </div>
...
<?php /* // BM: table view */ ?>
                    ...
                    <div class='col-xs-12 col-sm-6 col-md-4 <?= $val['ispremium'] ? 'premium' : 'normal-o' ?>'>
                        <div class='border'>
                            ...
                            <div class='go-vacancy btn-white-green-wr'>
                                <a href='/vacancy/<?= $val['id'] ?>'>Просмотреть</a>
                            </div>
                            <br>
                        </div>
                    </div>
        ...
        <div style="margin-top: 0;font-family: Roboto-Regular, verdana, arial, Myriad-Pro, verdana, arial, Verdana, Arial;font-size: 16px;">
            <p><?php echo $this->ViewModel->getViewData()->pageMetaKeywords; ?></p>
</div>
