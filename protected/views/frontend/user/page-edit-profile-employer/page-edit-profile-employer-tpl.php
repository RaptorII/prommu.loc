                    ...
                    <?php endif; ?>
                                ...
                                <div class="epe__label epe__mess epe__select">
                                    ...
                                    <ul class="epe__select-list" id="epe-list-mess">
                                        ...
                                        <li>
                                            <input type="checkbox" name="epe-mess-skype" value="1" id="epe-mess-skype" data-mess="skype" <?=empty($viData['attribs']['skype']['val'])?'':'checked'?>>
                                            <label for="epe-mess-skype">Skype<b></b></label>
                                        </li>
                                        <li>
                                ...
                                <div class="epe__mess epe__mess-skype <?=empty($viData['attribs']['skype']['val'])?'off':''?>">
                                    <div class="epe__label">
                                        <span class="epe__label-name epe__phone-name">Skype:</span>
                                        <input type="text" name="user-attribs[skype]" value="<?=$viData['attribs']['skype']['val']?>" class="epe__input epe__phone phone-input" autocomplete="off">
