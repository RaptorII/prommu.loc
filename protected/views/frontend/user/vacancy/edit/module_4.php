  ...
  <form class="module_form<?=$viData->error_moodule==$module?' block__visible':''?>" method="post" data-params='{"ajax":"true"}'>
    ...
    <div class="form__field">
      ...
      <div class="form__field-content form__content-indent form__content-hint">
        ...
        <? endif; ?>
        <div class="form__field-input form__field-select prmu-required" data-params='{"parent_tag":".form__field-content","message":"Поле обязательно к заполнению"}' id="posts2">
          <select name="post[]">
