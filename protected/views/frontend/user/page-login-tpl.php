...
<div class='row'>
  <div class='col-xs-12 auth-form__wrap'>
    <div class="row auth-form__header">
        <div class="col-xs-12 col-sm-8"><h1 class='auth-form__title'>Вход</h1></div>
        <div class="col-xs-12 col-sm-4"></div>
    </div>

    <div class="col-xs-12 col-sm-8 auth-form__form">
      <span class="auth-form__preview">Введите свои данные или 
        <span class="auth-form__reg-link">
        ...
        </ul>зарегистрируйтесь
        </span>, если Вы здесь впервые
      </span>
