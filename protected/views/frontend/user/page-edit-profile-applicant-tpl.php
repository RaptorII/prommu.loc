...
<div class='row page-applicant-profile-edit'>
  <?php
    if( Yii::app()->getRequest()->getParam('ep', 0) == 1 ) $this->renderPartial('page-edit-profile-applicant' . '/page-edit-photo-tpl', array('viData' => $viData));
    else $this->renderPartial('page-edit-profile-applicant' . '/page-edit-data-tpl', array('viData' => $viData));
  ?>
</div>
