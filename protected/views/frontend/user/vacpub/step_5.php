    ...
    <div class="form__field">
      <div class="form__field-content form__content-indent form__field-first">
          ...
          <div class="form__description">
            <p class="text_justify">Премиум вакансии ускоряют процесс подбора персонала в несколько раз. Такие вакансии выделяются рамкой и демонстрируются вне очереди на главной странице сайта и в списке вакансий, не опускаясь ниже первой страницы. Привлекает максимальное количество откликов со стороны Соискателей</p>
            ...
            <p class="text_justify">Более <span id="premium_percent"></span>% вакансий за <span id="premium_days"></span> дня <b>Премиум размещения</b> набирают достаточное количество откликов, чтобы найти сотрудников и закрыть вакансию</p>
          </div>
      </div>
    </div>
    <?
