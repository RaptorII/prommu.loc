  ...
  <div class="row">
    <div class="col-xs-12 sms-service">
      ...
      <h1 class="smss-result__title">ТЕКСТ РАССЫЛКИ</h1>
			<span class="smss-result__result" style="font-size:23px">Работодатель <?=Share::$UserProfile->exInfo->name?> приглашает на вакансию <a href="https://prommu.com/vacancy/<?=Yii::app()->getRequest()->getParam('vacpush')?>">https://prommu.com/vacancy/<?=Yii::app()->getRequest()->getParam('vacancy')?></a></span></br>
