            ...
            <form action="<?= MainConfig::$PAGE_VACANCY_EDIT . DS . $viData['vac']['id'] ?>" method="POST"
                ...
                <div class='col-xs-12 col-sm-8 col-lg-9'>
                    ...
                    <label class="erv__label erv__label-title" data-info="Заголовок вакансии * (не более 70 символов)">
                        <input type="text" name="vacancy-title" class="erv__input" placeholder="Заголовок вакансии *"
                        ...
                        <div class="erv__services">
                            <?php if ($viData['vac']['ismoder'] == 100): // отображать услуги только для промодерированных вкансий ?>
                                ...
                                <a href="<?= MainConfig::$PAGE_ORDER_SERVICE . "?id={$viData['vac']['id']}&service=outsourcing" ?>"
                                   class="erv__services-link erv__services-atsrc js-g-hashint" title="Аутсорсинг"></a>
                                <a href="<?= MainConfig::$PAGE_ORDER_SERVICE . "?id={$viData['vac']['id']}&service=outstaffing" ?>"
                                   class="erv__services-link erv__services-outstf js-g-hashint" title="Аутстаффинг"></a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="erv__subtitle erv__subtitle-who"><h2>Какой специалист нужен и с какими параметрами?</h2>
                    </div>
                                    ...
                                    <?php foreach ($viData['vac']['post'] as $k => $v): ?>
                                        <? if ($k == $custom): ?>
                                            <li data-id="new"><?= $v ?><i></i><input type="hidden" name="post-self"
                                                                                     value="<?= $v ?>"></li>
                                        <? else: ?>
                                            <li data-id="<?= $k ?>"><?= $v ?><i></i><input type="hidden" name="posts[]"
                                                                                           value="<?= $k ?>"></li>
                                        <? endif; ?>
                                    <?php endforeach; ?>
                                </ul>
                        ...
                        <div class="erv__label erv__label-tbl"
                            ...
                            <div>
                                ...
                                <label class="erv__label-age">
                                    ...
                                    <input type="text" name="age-from" class="erv__input erv__required erv__input-mini"
                                           id="rv-age-from" value="<?= $viData['vac']['agefrom'] ?>">
                                </label>
                                <label class="erv__label-age">
                                    <span class="erv__input-name">до</span>
                                    <input type="text" name="age-to" class="erv__input erv__required erv__input-mini"
                                           id="rv-age-to"
                            ...
                            <div>
                                ...
                                <input type="checkbox" name="wonem" class="erv__input erv__required erv__hidden"
                                       id="rv-sex-woman" value="1" <?= ($viData['vac']['iswoman'] ? 'checked' : '') ?>>
                                ...
                                <ul class="erv__select-list" id="rv-hlen-list">
                                    ...
                                    <?php foreach ($viData['userDictionaryAttrs'] as $prop): ?>
                                        <?php if ($prop['idpar'] == 12): ?>
                                            <li>
                                                <input type="radio" name="user-attribs[hlen]" value="<?= $prop['id'] ?>"
                    ...
                    <div class="erv__module">
                            ...
                            <ul class="erv__select-list" id="rv-paylims-list">
                                ...
                                <?php foreach ($viData['userDictionaryAttrs'] as $val): ?>
                                    <?php if ($val['idpar'] == 131): ?>
                                        <li>
                                            <input type="radio" name="user-attribs[paylims]" value="<?= $val['id'] ?>"
                                ...
                                <?php if ($custPay): // свой вариант ?>
                                    <li>
                                        <input type="radio" name="user-attribs[paylims]" value="164" id="paylims-164"
                                               checked>
                        ...
                        <div class="erv__label erv__label-tbl">
                            ...
                            <div>
                                <input type="checkbox" name="bank-card" class="erv__input erv__hidden" id="rv-bank-card"
