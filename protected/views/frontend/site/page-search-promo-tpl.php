...
/*smal icons*/
    ...
    .alib__img-link::after  {
        transition: all .3s linear;
        position: absolute;
        opacity: 0;
        top: 100%;
    }
    .alib__img-link:hover::after {
    ...
    .psa__view-list:after,
    .psa__view-table:after{
        font-family: "PrommuFont";
        content: '';
    }
    .psa__view-list:after{ content: '\e96a'; color: var(--color-grey);}
    .psa__view-table:after{ content: '\e972'; color: var(--color-grey);}
    .psa__view-list.active:after{ content: '\e96a'; color: var(--color-green); }
    .psa__view-table.active:after{ content: '\e972'; color: var(--color-green); }
    .psa__nothing{
        color: #343434;
        font-size: 18px;
    }
