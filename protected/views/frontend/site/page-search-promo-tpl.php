...
<style type="text/css">
    ...
    #DiContent.page-ankety .page-search-ankety .psv__salary-label {
        width: 50%;
        float: left;
        padding-left: 35px;
        position: relative
    ...
    #DiContent .page-search-ankety .psv__input, .psv__content, .psv__salary-name {
        font-family: RobotoCondensed-Regular, verdana, arial
    }

    #DiContent.page-ankety .page-search-ankety .filter .filter-label.filter-cities {
        padding-top: 0
    }
    ...
    #DiContent.page-ankety .filter-salary .filter-content label {
        display: block;
        text-align: left
    }

    .psa__btn:before, .psa__checkbox-label:after, .psa__filter-btn:before, .psa__header-name:before, .psa__veil:before {
        content: ''
    }

    #psa-additional, .psa__veil {
        display: none
    }

    .page-search-ankety .select2-container--default .select2-selection--multiple {
        width: 100%;
        min-height: 35px;
        padding: 0 15px;
    ...
    #DiContent .page-search-ankety .psa__input, #DiContent .psa__checkbox-label, .psa__content {
        font-family: RobotoCondensed-Regular, verdana, arial
    }

    .page-search-ankety .select2-container--default.select2-container--focus .select2-selection--multiple {
        border: 1px solid #EBEBEB;
        outline: 0
    }

    .page-search-ankety .select2-container--default .select2-selection--multiple .select2-selection__choice {
        background-color: rgba(52, 52, 52, .6);
        color: #FFF;
        border-color: #858585
    }

    #DiContent.page-vacancy .page-search-ankety .filter .filter-name, .psa__filter-name {
        border: 1px solid #e3e3e3
    }

    #DiContent.page-vacancy .page-search-ankety .filter .filter-content label {
        font-size: 14px;
        color: #A0A0A0;
        font-family: RobotoCondensed-Regular, verdana, arial;
        text-transform: none
    ...
    .psa__filter-btn, .psa__filter-name {
    ...
    .psa__view-list, .psa__view-table {
        width: 19px;
        height: 15px;
        display: block;
        margin-left: 8px;
        float: right;
        background: url(/theme/pic/vacancy/srch-vac-sprite.png) no-repeat
    }
    ...
    .psa__view-list.active {
        background-position: 0 -15px
    }

    .psa__view-table.active {
    ...
    .psa__filter-name.opened {
        background: #e3e3e3;
        border-color: #e3e3e3
    }

    .psa__filter-name:not(.opened):hover {
        border-color: #abb820
    }

    .psa__filter-name:after {
        content: ' ';
        position: absolute;
        right: 15px;
        top: 0;
    ...
    .psa__filter-content.opened {
        display: block
    }

    #DiContent .page-search-ankety .psa__input {
        height: 35px;
        border: 1px solid #EBEBEB;
        background-color: transparent;
        padding: 0 15px;
    ...
    #DiContent .page-search-ankety .psa__btn, .psa__filter-btn:before {
        -webkit-transition: all .3s ease-out;
        -moz-transition: all .3s ease-out;
        -o-transition: all .3s ease-out
    }

    .psa__filter-btn:before {
        position: absolute;
        z-index: -1;
        top: 0;
        left: 0;
    ...
    .psa__filter-btn:hover:before {
        -webkit-transform: scaleX(1);
        transform: scaleX(1)
    }

    #DiContent .psa__checkbox-input {
        display: none
    }
    ...
    .psa__checkbox-label:hover:after {
    ...
    #DiContent.page-ankety .page-search-ankety .filter {
        display: block
    }

    .filter-positions .psa__filter-content.opened {
        height: 170px;
        position: relative;
        overflow: hidden
    }
    ...
    .more-posts {
        ...
        font-size: 16px;
        background: 0 0;
        background: -moz-linear-gradient(top, transparent 0, #FFF 50%, #FFF 100%);
    ...
    #DiContent .page-search-ankety .psa__btn {
        line-height: 30px;
        display: block;
        margin: 0 auto;
        padding: 0;
    ...
    .psa__btn:hover:before {
        -webkit-transform: scaleX(1);
        transform: scaleX(1)
    }

    #DiContent .page-search-ankety .psa__header-btn {
        width: 195px
    }
    ...
    .filter-positions .psa__checkbox-label:nth-child(2) {
        margin-bottom: 20px
    }
    ...
    .psa__filter-vis:before, .psa__filter-vis:after {
        content: '';
        width: 0;
        height: 0;
        display: block;
        ...
        border-bottom: 15px solid #abb820;
    }

    .psa__filter-vis:before {
        left: 10px
    }

    .psa__filter-vis:after {
        right: 10px
    }

    .psa__filter-vis.active:before, .psa__filter-vis.active:after {
        border-bottom: initial;
        border-top: 15px solid #abb820;
    }

    #DiContent .table-view .comm-logo > a:first-child {
        display: block;
        border-radius: 50%;
    ...
    .promo-list__item-onl span, .promo-list__item-onl span:hover {
        color: #abb820;
        font-size: 12px;
        font-weight: 700;
        position: relative;
    ...
    .promo-list__item-onl span:after {
        content: '';
        width: 10px;
        height: 10px;
        position: absolute;
    ...
    #filter-city .select-list li {
        padding: 0 15px;
        text-align: left
    }

    #DiContent #filter-city .filter-city-select input {
        padding: 0;
        border: none;
        background: 0 0;
    ...
    #DiContent #filter-city .filter-city-select input:focus {
        outline: 0
    }

    .filter-city-select.load:after {
        content: '';
        width: 20px;
        height: 20px;
        right: 3px;
        background: url(/theme/pic/loading1.gif) no-repeat;
        background-size: cover;
        top: 7px;
        position: absolute
    }

    .city-select, .filter-city-select li:not([data-id="0"]) {
        display: inline-block;
    ...
    .filter-city-select li:not([data-id="0"]) {
        line-height: 23px
    }

    .filter-city-select li[data-id="0"] {
        width: 10px
    }
    ...
    .city-select b, .filter-city-select b {
        width: 19px;
        height: 19px;
        display: block;
        position: absolute;
    ...
    .filter-city-select b {
        top: 5px
    }

    .city-select b:before, .filter-city-select b:before {
        content: '\2716';
        display: block;
        position: absolute;
        top: 0;
    ...
    #DiContent .project__index-time input {
        text-align: center;
    ...
    #DiContent.page-ankety .page-search-ankety .filter-salary label, .psa__age-label span {
        font-size: 14px;
        color: #A0A0A0;
        font-family: RobotoCondensed-Regular, verdana, arial;
        text-transform: none
                                    ...
                                    <div class='company-logo-wrapp'>
                                        <div class='company-logo'>
                                            <a href='<?= MainConfig::$PAGE_PROFILE_COMMON . DS . $val['id_user'] ?>'>
                                                <?php if ($val['sex']): ?>
                                                    <img alt='Соискатель <?= $val['firstname'] . ' ' . $val['lastname'] ?> prommu.com'
                                                         src='<?= DS . MainConfig::$PATH_APPLIC_LOGO . DS . (!$val['photo'] ? MainConfig::$DEF_LOGO : $val['photo'] . '100.jpg') ?>'>
                                                <?php else: ?>
                                                    <img alt='Соискатель <?= $val['firstname'] . ' ' . $val['lastname'] ?> prommu.com'
                                                         src='<?= DS . MainConfig::$PATH_APPLIC_LOGO . DS . (!$val['photo'] ? MainConfig::$DEF_LOGO_F : $val['photo'] . '100.jpg') ?>'>
                                                <?php endif; ?>
                                ...
                                <div class='col-xs-12 col-sm-8'>
                                    ...
                                    <div class='charac clearfix'>
                                        <div class='rate' title="положительный / отрицательный">
                                            Рейтинг: <b class="green"><?= $val['rate'] ?></b> / <b
                                                    class="red"><?= $val['rate_neg'] ?></b>
                                        </div>
                                ...
                                <div class='comm-logo'>
                                    ...
                                    <div class='hr'>
                                        ...
                                        <?php if (is_numeric($val['rate'])): ?>
                                            <div class='rate js-g-hashint'
                                                 title='Рейтинг положительный | отрицательный'>
