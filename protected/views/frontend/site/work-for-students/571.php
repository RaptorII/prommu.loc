...
<div class="work-for-students__wrapper">
	<div class="wfs-wrapper__title">
		<h1 class="wfs-wrapper__title-h1">
			...
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-green">в Нижнем Новгороде</span></span>
		</h1>
	</div>
</div>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__vacancies">
			<h2 class="wfs-vacancies__title">Варианты вакансий работы на лето для студентов
			...
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif;">У нас вы найдете широкий выбор вакансий для студентов без опыта работы в Нижнем Новгороде. Среди наиболее популярных профессий стоит выделить:</p>
			<ul class="wfs-vacancies__small-list">
				<li class="wfs-vacancies__li"><span>промоутеров;</span></li>
				<li class="wfs-vacancies__li"><span>флагомахов;</span></li>
				<li class="wfs-vacancies__li"><span>ростовых кукол;</span></li>
				<li class="wfs-vacancies__li"><span>промо-моделей;</span></li>
				<li class="wfs-vacancies__li"><span>стендистов;</span></li>
				<li class="wfs-vacancies__li"><span>мерчендайзеров;</span></li>
				<li class="wfs-vacancies__li"><span>аниматоров;</span></li>
				<li class="wfs-vacancies__li"><span>супервайзеров;</span></li>
			</ul>
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif;">Должности сильно отличаются по своим требованиям и обязанностям, так что можно подобрать тот вариант, что больше всего подходит именно вам.</p>
			<h3 style="font-size:20px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif;border-bottom:6px solid #abb837;">Особенности сотрудничества с нами</h3>
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif;">Наш портал предлагает для соискателей следующие преимущества:</p>
			<ul class="wfs-vacancies__small-list">
				<li class="wfs-vacancies__li"><span>обширная база вакансий (при помощи удобного фильтра вы сможете отсеять неинтересные предложения);</span></li>
				<li class="wfs-vacancies__li"><span>возможность заполнить анкету (это повышает вероятность приглашения на собеседование);</span></li>
				<li class="wfs-vacancies__li"><span>специальное мобильное приложение, которое позволяет искать подработку со своего смартфона, а также открывает доступ к ряду полезных опций (например, автоматическое уведомление о новых вакансиях на планшет или мобильный телефон);</span></li>
				<li class="wfs-vacancies__li"><span>система рейтингов и отзывов о работодателях (она поможет определить самых лучших и наиболее ненадежных заказчиков).</span></li>
			</ul>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__advantages">
			...
			<p class="wfs-advantages-item__text">Стоит отметить, что такая занятость не только позволяет подзаработать. Кроме того, работая в сфере BTL, вы:</p><br>
			<div class="row wfs-advantages__list">
				<div class="col-xs-12 wfs-advantages__item">
					...
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Улучшаете коммуникативные навыки</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Умение общаться – одно из наиболее важных в любой профессии. Промо-сотрудники постоянно контактируют с людьми, так что со временем их навыки общения улучшаются</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico3"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Получаете опыт</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Таким образом, вы станете более конкурентоспособным на рынке труда. При этом даже если должность неофициальная, ее все равно стоит вписать в резюме</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico1"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Учитесь работать в команде</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Только слаженные действия промо-персонала позволяет провести успешное мероприятие. Умение сотрудничать с другими людьми пригодится практически в любой сфере деятельности</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico4"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Понимаете, как убеждать клиентов</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Если вы научитесь убеждать и продавать, то сможете добиться успеха в будущем</p>
					</div>
				</div>
			</div>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__bottom-text">
			<h2 style="text-align:center;font-size:16px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif">Какой может быть подработка на лето для студентов в Нижнем Новгороде</h2>
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif">Гибкий график – одно из основных преимуществ занятости в данной сфере. Вы можете выбрать вакансию раздачи листовок студентов или любую другую подработку на выходные, по вечерам или на несколько часов в день. С таким графиком у вас останется много времени, чтобы нормально отдохнуть летом, а также заняться любыми другими делами.</p>
		</div>
	</div>
</div>
