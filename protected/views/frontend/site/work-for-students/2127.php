...
<div class="work-for-students__wrapper">
	<div class="wfs-wrapper__title">
		<h1 class="wfs-wrapper__title-h1">
			<span class="wfs-wrapper__title-light wfs-wrapper__title-bg">Сайт поиска работы</span><br>
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-orange">для студентов</span></span><br>
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-green">в Казани</span></span>
		</h1>
	</div>
</div>
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs-prolog__text">
			<p>Наш сайт работы для студентов специализируется на трудоустройстве в сфере BTL и Event. После регистрации на портале, вы получите доступ к нашей обширной базе вакансий. Кроме того, мы рекомендуем заполнить свою анкету, чтобы работодатели сами связывались с вами, если резюме будет им интересным. Сочетание этих двух методов позволит вам максимально быстро найти неплохую временную подработку.</p>
		</div>
		<!--noindex-->
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__vacancies">
			<h3 class="wfs-vacancies__title">Какой должна быть подработка на лето
				<span class="wfs-vacancies__title-light">для студентов в Казани</span>
			</h3>
			...
			<p class="wfs-vacancies__text">При выборе временной профессии среди множества вакансий следует учитывать ряд факторов:</p>
			<ul class="wfs-vacancies__small-list">
				<li class="wfs-vacancies__li"><span>необходимые требования. У большинства студентов нет ни опыта, ни высшего образования, ни определенных специфических навыков. В результате, немногие работодатели готовы принять их к себе в штат. Наиболее выгодным тут выглядит трудоустройство в сфере маркетинга – для большинства специалистов из области BTL и Event требуются лишь общие знания и умения;</span></li>
				<li class="wfs-vacancies__li"><span>график работы. Важно, чтобы занятость оставляла время для учебы. Летом можно попробовать себя в качестве замены основных сотрудников, которые идут в отпуск. В остальной период следует искать занятость по нескольку часов в день или по выходным. Работа промо-специалистом отличается своей гибкостью. Например, раздача листовок студентами предполагает распространение рекламных материалов в любое удобное для вас время (утром, днем, вечером). На других промо-должностях также можно подстроить свой рабочий график под другие дела;</span></li>
				<li class="wfs-vacancies__li"><span>возможность улучшить навыки и получить опыт. Во время проведения промо-мероприятий специалисты постоянно общаются с потенциальными клиентами, решают различные непредвиденные ситуации, работают в команде. Все это делает вас более конкурентоспособным на рынке труда. Как результат, все эти навыки и опыт пригодятся при дальнейшем трудоустройстве;</span></li>
				<li class="wfs-vacancies__li"><span>уровень оплаты. В основном, студенты ищут подработку с определенной целью: стать финансово независимым или накопить определенную сумму на покупку чего-либо. Сфера маркетинга быстро развивается, так что и уровень оплаты там весьма неплохой (200-500 рублей в час). Стоит также отметить, что расчет происходит каждый день, так что вы получите деньги максимально быстро.</span></li>
			</ul>
			<br>
			<p class="wfs-vacancies__text">Естественно, можно устроиться грузчиком, официантом или оператором call-центра, но именно занятость в сфере BTL и Event на данный момент пользуется наибольшим спросом на рынке труда.</p>
			<!--noindex-->
		...
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				<h2 class="wfs-tutorial__title">
					Лучшие вакансии работы на летний и другие периоды 
					<span class="wfs-tutorial__title-light">для студентов в Казани</span>
				</h2>
				<hr class="wfs-tutorial__line">
				<p style="font-size:18px;color:#ffffff;">Среди наиболее востребованных специалистов из области маркетинга в нашем городе следует выделить такие профессии:</p>
				<ul style="font-size:18px;color:#ffffff;padding-left:20px">
					<li>промоутеры (привлекают внимание публики);</li>
					<li>мерчендайзеры (осуществляют выкладку товаров и оформление стендов);</li>
					<li>тайные покупатели (проводят маркетинговые исследования и оценивают качество обслуживания);</li>
					<li>супервайзеры (курируют работу остальных промо-сотрудников).</li>
				</ul>	
				<p style="font-size:18px;color:#ffffff;margin-bottom:30px">Кроме того, у нас вы найдете вакансии и на множество других должностей.</p>
				<!--noindex-->
	...
	<div class="row">
		<div class="col-xs-12 wfs__advantages">
			<h3 class="wfs-advantages__title">
				Почему стоит искать подработку для студентов с ежедневной оплатой
				<span class="wfs-advantages__title-reg"> с помощью портала Prommu</span>
			</h3>
			<hr class="wfs-advantages__line">
			<p style="font-family:RobotoCondensedLight,sans-serif,verdana;text-align:justify;color:#646464;font-size:18px;margin:0 0 50px">Среди преимуществ трудоустройства с нашей помощью, можно выделить:</p>
			<div class="row wfs-advantages__list">
				<div class="col-xs-12 wfs-advantages__item">
					...
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Работа на любой вкус</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Большой выбор предложений от реальных работодателей. Наши модераторы постоянно проверяют вакансии на их актуальность, так что вы не потратите время зря, а также не попадете на мошенников;</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico2"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Оповещения</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Систему оповещений на смартфон или электронную почту;</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico3"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Мобильное приложение</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Удобное мобильное приложение, которое поможет вам искать вакансии прямо со своего телефона;</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico4"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Настраиваемый фильтр</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Позволит отсеять неинтересные вакансии и т. д.</p>
					</div>
				</div>
			</div>
			<p style="font-family:RobotoCondensedLight,sans-serif,verdana;text-align:justify;color:#646464;font-size:18px;margin:0 0 50px">Зарегистрировавшись на нашем портале, вы уже скоро сможете найти вакансии для студентов без опыта работы в Казани и оценить все преимущества занятости в сфере BTL и Event.</p>
		</div>
	</div>
</div>
<div class="container-fluid wfs__content">
