	...
	<div class="container-fluid wfs__content">
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				...
				<p style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;">Среди наиболее востребованных специалистов из области маркетинга в нашем городе следует выделить такие профессии:</p>
				...
				<p style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;margin-bottom:30px">Кроме того, у нас вы найдете вакансии и на множество других должностей.</p>
				<!--noindex-->
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__advantages">
			...
			<p style="font-family:RobotoCondensedLight,RobotoCondensedRegular,Calibri,Arial,sans-serif;text-align:justify;color:#646464;font-size:18px;margin:0 0 50px">Среди преимуществ трудоустройства с нашей помощью, можно выделить:</p>
			...
			<p style="font-family:RobotoCondensedLight,RobotoCondensedRegular,Calibri,Arial,sans-serif;text-align:justify;color:#646464;font-size:18px;margin:0 0 50px">Зарегистрировавшись на нашем портале, вы уже скоро сможете найти вакансии для студентов без опыта работы в Казани и оценить все преимущества занятости в сфере BTL и Event.</p>
		</div>
	</div>
</div>
<div class="container-fluid wfs__content">
