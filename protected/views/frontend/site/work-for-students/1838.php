<style type="text/css">
    ...
    .wfs-prolog-item__img.ico1:after{ content: '\e95b' }
    .wfs-prolog-item__img.ico2:after{ content: '\e95c' }
    .wfs-prolog-item__img.ico3:after{ content: '\e959' }
    .wfs-prolog-item__img.ico4:after{ content: '\e957' }

    .wfs-services-item__img{
        width: 90px;
        height: 105px;
        margin: 0 auto 10px;
    }
    .wfs-services-item__img:after{
        font-family: "PrommuFont";
        content: '';
    ...
    .wfs-services-item__img.ico1:after{ content: '\e960' }
    .wfs-services-item__img.ico2:after{ content: '\e95f' }
    .wfs-services-item__img.ico3:after{ content: '\e961' }
    .wfs-services-item__img.ico4:after{ content: '\e981' }
    .wfs-services-item__img.ico5:after{ content: '\e95e' }
    .wfs-services-item__img.ico6:after{ content: '\e962' }
    .wfs-services-item__name{
        min-height: 60px;
        border-bottom: 3px solid #cae100;
        margin-bottom: 25px;
        font-weight: bold;
    ...
    .wfs-advantages-item__img:after{
        font-family: "PrommuFont";
        content: '';
        color: var(--color-green);
        font-size: 97px;
    ...
    .wfs-advantages-item__img.ico1:after{ content: '\e955' }
    .wfs-advantages-item__img.ico2:after{ content: '\e98d' }
    .wfs-advantages-item__img.ico3:after{ content: '\e958' }
    .wfs-advantages-item__img.ico4:after{ content: '\e95d' }
    .wfs-advantages-item__img.ico5:after{ content: '\e95a' }
