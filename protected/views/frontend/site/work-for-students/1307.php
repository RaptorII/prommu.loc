		...
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				...
				<div class="row wfs-tutorial__list">
					<div class="col-xs-12 col-sm-4 wfs-tutorial__item"><a href="<?=Yii::app()->createUrl(MainConfig::$PAGE_REGISTER, array('p' => '1'))?>" class="wfs-tutorial__item-link btn__orange" title='Зарегистрируйтесь'>Зарегистрируйтесь</a>на нашем портале</div>
	...
	<div class="row">
		<div class="col-xs-12 wfs-register">
			...
			<div class="wfs-register__info">
				...
				<a href="<?=Yii::app()->createUrl(MainConfig::$PAGE_REGISTER, array('p'=>'1'))?>" class="wfs-register__btn btn__orange" title='Зарегистрироваться'>ЗАРЕГИСТРИРОВАТЬСЯ</a>
			</div>
		</div>
	</div>
</div>
