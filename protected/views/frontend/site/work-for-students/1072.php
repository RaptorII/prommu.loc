...
<div class="work-for-students__wrapper">
	<div class="wfs-wrapper__title">
		<h1 class="wfs-wrapper__title-h1">
			<span class="wfs-wrapper__title-light wfs-wrapper__title-bg">Портал поиска работы</span><br>
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-orange">для студентов</span></span><br>
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-green">в Красноярске</span></span>
		</h1>
	</div>
</div>
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs-prolog__text">
			<p>Мы предлагаем вам ознакомиться с нашей обширной базой вакансий для студентов без опыта работы в Красноярске. Чтобы увидеть все предложения от работодателей, а также получить доступ ко многим другим полезным опциям, зарегистрируйтесь на нашем портале.</p>
		</div>
		...
		<div class="col-xs-12 wfs-prolog__text" style="padding-top:0">
			...
			<p>В последнее время сфера маркетинга является одной из самых быстрорастущих. Как результат, работодатели привлекают в свой штат все больше специалистов для проведения различных BTL и Event-мероприятий. С другой стороны, такая занятость пользуется широким спросом среди соискателей в силу весьма неплохого уровня заработной платы и гибкого графика (занятость можно с легкостью совмещать с учебой).</p>
			<p>При этом трудоустроиться в сфере маркетинга достаточно просто, ведь для этого не требуется ни опыт, ни образование. Часто работодатели ищут именно молодых и активных парней с девушками, так что у студентов никаких проблем с получением должности не возникнет</p>
			<!--/noindex-->
		</div>
	</div>
</div>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__vacancies">
			<h2 class="wfs-vacancies__title">Правила поиска подработки для студентов  
				<span class="wfs-vacancies__title-light">с ежедневной оплатой</span>
			</h2>
			...
			<p style="font-size:15px;color:#646464;">При поиске подходящей занятости, наш сайт работы для студентов рекомендует придерживаться следующих правил:</p>
			<ul class="wfs-vacancies__small-list">
				<li class="wfs-vacancies__li"><span>Ищите работу с гибким графиком. Стоит помнить, что на этом этапе жизни в приоритете должна быть учеба. Следует обращать внимание на трудоустройство по несколько часов в день, на выходных или по праздникам. Таким образом, занятость не будет отвлекать вас от остальных дел. Кроме того, не нужно перегружать себя, лучше оставить немного времени для отдыха</span></li>
				<li class="wfs-vacancies__li"><span>Избегайте слишком высоко- и низкооплачиваемых должностей. В первом случае высока вероятность различных мошенников. Второй вариант не позволит вам накопить желаемую сумму</span></li>
				<li class="wfs-vacancies__li"><span>Отдавайте предпочтение временной занятости. Как результат, не будут возникать длительные обязательства, так что вы с легкостью сможете сменить должность</span></li>
				<li class="wfs-vacancies__li"><span>Подбирайте профессию, которая будет улучшать навыки. Особенно следует обратить внимание на должности, связанные с общением с людьми. В какой бы сфере вы не работали в дальнейшем, развитые коммуникативные способности станут большим плюсом для карьерного роста</span></li>
			</ul>
			<p style="font-size:15px;color:#646464;">Если говорить о конкретных профессиях, то наиболее выгодным в этом плане выглядит трудоустройство в сфере BTL и Event. Высокая заработная плата, отсутствие серьезных требований и возможность трудоустроиться на несколько дней или часов делают область маркетинга хорошим выбором для временной подработки.</p>
			<!--noindex-->
			<p style="font-size:15px;color:#646464;border-bottom:6px solid #abb837;padding-bottom:45px">С нами вы уже скоро сможете найти хорошую временную подработку, которая не будет мешать учебе.</p>
	...
	<div class="container-fluid wfs__content">
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				...
				<h2 class="wfs-tutorial__title">
					Как лучше всего искать вакансии работы на лето 
					<span class="wfs-tutorial__title-light">для студентов в Красноярске</span>
				</h2>
				<hr class="wfs-tutorial__line">
				<p style="font-size:18px;color:#ffffff;">Быстрее всего работу можно найти с помощью нашего специализированного портала. В базе сайта вы увидите десятки различных вакансий на должности в сфере BTL и Event. Благодаря широкому выбору профессий, можно подобрать для себя подходящую должность за короткий промежуток времени.</p>
				<p style="font-size:18px;color:#ffffff;">При этом искать занятость с нами очень легко. Для этого необходимо придерживаться 4 простых шагов:</p>
				<ol style="font-size:18px;color:#ffffff;padding-left:20px">
					<li>Зарегистрироваться на сайте (вся процедура потребует у вас не более нескольких минут)</li>
					<li>Регулярно просматривать вакансии и откликаться на самые перспективные предложения. Благодаря нашей удобной системе поиска, вы можете отсеять неинтересные вакансии, что существенно сэкономит ваше время</li>
					<li>Заполнить свою анкету (ее смогут увидеть работодатели). Наличие заполненного резюме с фотографией существенно увеличивает шанс быстро найти хорошую должность</li>
					<li>Ждать приглашений на собеседование.</li>
				</ol>	
				<p style="font-size:18px;color:#ffffff;margin-bottom:30px"></p>
				<!--noindex-->
	...
	<div class="row">
		<div class="col-xs-12 wfs__advantages">
			<h3 class="wfs-advantages__title">
				Подработка на лето для студентов в Красноярске 
				<span class="wfs-advantages__title-reg">с помощью портала Промму</span>
			</h3>
			<hr class="wfs-advantages__line">
			<p class="wfs-advantages-item__text" style="font-size:18px">С нами соискатели могут рассчитывать на следующие преимущества:</p><br>
			<div class="row wfs-advantages__list">
				<div class="col-xs-12 wfs-advantages__item">
					...
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">База вакансий</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Большая база вакансий, которая регулярно пополняется. Все предложения от заказчиков проверяются нашими модераторами, в силу чего вы можете быть уверены, что не попадете на мошенников;</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico2"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Приложение для мобильного</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Специальное приложение для мобильного телефона Prommu. Оно не только открывает доступ ко всем возможностям компьютерной версии портала, но также позволяет получать необходимые уведомления прямо на свой смартфон</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico3"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Система отзывов и рейтингов</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Система отзывов и рейтингов, благодаря которой вы избежите недобросовестных заказчиков</p>
					</div>
				</div>
			</div>
			<p class="wfs-advantages-item__text" style="font-size:18px">С нами вы максимально быстро найдете подработку по раздаче листовок для студентов, а также другие интересные должности.</p>
		</div>
	</div>
</div>
<div class="container-fluid wfs__content">
