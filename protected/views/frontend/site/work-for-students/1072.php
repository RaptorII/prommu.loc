...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__vacancies">
			...
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif;">При поиске подходящей занятости, наш сайт работы для студентов рекомендует придерживаться следующих правил:</p>
			...
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif;">Если говорить о конкретных профессиях, то наиболее выгодным в этом плане выглядит трудоустройство в сфере BTL и Event. Высокая заработная плата, отсутствие серьезных требований и возможность трудоустроиться на несколько дней или часов делают область маркетинга хорошим выбором для временной подработки.</p>
			<!--noindex-->
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif;border-bottom:6px solid #abb837;padding-bottom:45px">С нами вы уже скоро сможете найти хорошую временную подработку, которая не будет мешать учебе.</p>
	...
	<div class="container-fluid wfs__content">
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				...
				<p style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;">Быстрее всего работу можно найти с помощью нашего специализированного портала. В базе сайта вы увидите десятки различных вакансий на должности в сфере BTL и Event. Благодаря широкому выбору профессий, можно подобрать для себя подходящую должность за короткий промежуток времени.</p>
				<p style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;">При этом искать занятость с нами очень легко. Для этого необходимо придерживаться 4 простых шагов:</p>
				<ol style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;padding-left:20px">
				...
				<p style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;margin-bottom:30px"></p>
				<!--noindex-->
