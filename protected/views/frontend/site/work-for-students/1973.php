...
<div class="work-for-students__wrapper">
	<div class="wfs-wrapper__title">
		<h1 class="wfs-wrapper__title-h1">
			...
			<span class="wfs-wrapper__title-bg">для студентов</span>
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-green">в Екатеринбурге</span></span>
		</h1>
	</div>
</div>
<div class="container-fluid wfs__content">
	<div class="row">
		...
		<div class="col-xs-12 wfs-prolog__text" style="padding-top:0">
			...
			<p>Из других преимуществ занятости в данной сфере стоит выделить:</p>
			<ul>
				<li>простоту трудоустройства. Достаточно часто студентов не хотят принимать на работу в силу отсутствия опыта и образования. В случае с занятостью в сфере BTL и Event, таких ограничений нет, так как от сотрудников не требуются никакие специальные навыки и умения;</li>
				<li>высокий уровень заработной платы. Оплата почасовая, выплаты проводятся каждый день;</li>
				<li>улучшение навыков и умений. Вы научитесь лучше общаться с людьми, а также поймете, как правильно работать в коллективе и решать конфликтные ситуации и и работать с возражениями;</li>
				<li>гибкий график. Наверное, самый важный плюс для студентов. Вы можете принимать участие в регулярных акциях по вечерам или выходным, а также работать только пару дней или часов на разовых акциях. В результате, подработку можно с легкостью совмещать с учебой.</li>
			</ul>
			<p>Наконец, такая занятость принесет многим людям много положительных эмоций. Особенно следует попробовать себя в области маркетинга для тех, кто любит общаться с другими людьми, а также постоянно узнавать что-то новое.</p>
			<h2 style="text-align:center;margin-top:0">Какими качествами нужно обладать, чтобы найти хорошую подработку для студентов в Екатеринбурге</h2>
			<p>Чтобы стать хорошим промо-специалистом, нужно обладать следующими навыками:</p>
			<ul>
				<li>коммуникабельность (ведь придется общаться как с заказчиками, так и с потенциальными клиентами);</li>
				<li>опрятность (промо-сотрудник является лицом бренда, так что и внешний вид должен быть соответствующим);</li>
				<li>стрессоустойчивость (взаимодействие с людьми невозможно без различных непредвиденных ситуаций, так что умение решать конфликты пригодится).</li>
			</ul>
			<p>Обладая этими качествами, вам будет намного легче найти работу по раздаче листовок для студентов, а также другие специальности из области BTL.</p>
		</div>
	</div>
</div>
	...
	<div class="row">
		<div class="col-xs-12 wfs__vacancies">
			<h3 class="wfs-vacancies__title">Преимущества поиска вакансий работы на лето для студентов
				<span class="wfs-vacancies__title-light">в Екатеринбурге с нашим порталом</span>
			</h3>
			<hr class="wfs-vacancies__line">
			<p class="wfs-vacancies__text">Если вы решите искать временную или постоянную работу на нашем сайте, вы получаете:</p>
			<ul>
				<li>обширную базу актуальных вакансий. При этом все предложения регулярно обновляются и проверяются нашими модераторами;</li>
				<li>возможность заполнить свою анкету (так заказчики сами пригласят вас на собеседование, если резюме окажется интересным);</li>
				<li>удобный поиск, который позволяет отсеять ненужные вакансии;</li>
				<li>модерация вакансий, а также система отзывов и рейтингов (поможет вам не попасть на недобросовестных заказчиков)</li>
			</ul>
			<p class="wfs-vacancies__text">Таким образом, наш сайт поиска работы для студентов станет лучшим вариантом для тех, кто хочет найти хорошую подработку.</p>
	...
	<div class="container-fluid wfs__content">
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				...
				<p style="font-size:18px;color:#ffffff;">Чтобы найти подходящую вакансию, прежде всего, стоит зарегистрироваться на нашем портале. Далее вы можете:</p>
				...
				<p style="font-size:18px;color:#ffffff;margin-bottom:30px">Скачав мобильное приложение PROMMU на свой смартфон, все уведомления о новых предложениях от работодателей будут приходить прямо на ваше мобильное устройство.</p>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__bottom-text">
			<!--noindex-->
			<h3 style="text-align:center;font-size:16px;color:#646464">PROMMU – лучший портал поиска работы для студентов</h3>
			<p style="font-size:15px;color:#646464">Для соискателей мы предлагаем:</p>
			<ul style="font-size:15px;color:#646464">
			...
			<p style="font-size:15px;color:#646464">С нами вы без проблем найдете высокооплачиваемую и интересную подработку в своем городе.</p>
			<!--/noindex-->
		</div>
	</div>
</div>
