...
<div class="work-for-students__wrapper">
	<div class="wfs-wrapper__title">
		<h1 class="wfs-wrapper__title-h1">
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-orange">Лучшая работа</span></span>
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-green">для студентов в Волгограде</span></span>
		</h1>
	</div>
</div>
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs-prolog__text">
			<p>Наш портал предназначен для поиска работы, вакансий для студентов без опыта в Волгограде. Чтобы получить доступ к обширной базе предложений от реальных работодателей, просто зарегистрируйтесь на сайте Prommu. Также мы предлагаем вам заполнить свою анкету, что существенно упростит процесс поиска интересующей вас работы.</p>
		</div>
		<!--noindex-->
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__vacancies">
			<h3 class="wfs-vacancies__title">Самые перспективные вакансии на работу
				<span class="wfs-vacancies__title-light">для студентов в Волгограде</span>
			</h3>
			...
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif;">На данный момент рынок труда предлагает достаточно много интересных должностей для студентов на летний другие периоды, включая:</p>
			<ul class="wfs-vacancies__small-list">
				<li class="wfs-vacancies__li"><span>промоутеров. Такие специалисты раздают листовки и другие рекламные материалы, предлагают попробовать новый товар, консультируют потенциальных клиентов и пр.</span></li>
				<li class="wfs-vacancies__li"><span>ростовых кукол. Привлекают внимание аудитории с помощью специальных костюмов</span></li>
				<li class="wfs-vacancies__li"><span>мерчендайзеров. Отвечают за грамотную презентацию товара, оформление стендов, витрин и пр.</span></li>
				<li class="wfs-vacancies__li"><span>тайных покупателей. Под видом обычных клиентов проверяют качество работы сотрудников торговых заведений и промо-специалистов</span></li>
				<li class="wfs-vacancies__li"><span>супервайзеры. Следят за ходом BTL и Event-мероприятий. Контролируют и обучают остальной персонал</span></li>
			</ul>
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif;border-bottom:6px solid #abb837;padding-bottom:45px">Именно работа в сфере BTL и Event-мероприятий в последнее время выглядит наиболее перспективным вариантом для временного трудоустройства. Особенно если учесть, что большинство работодателей проводят промо-акции и другие похожие мероприятия в летний период.</p>
			<!--noindex-->
		...
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				<h3 class="wfs-tutorial__title">
					Почему стоит искать подработку на лето для студентов  
					<span class="wfs-tutorial__title-light">в Волгограде на портале Prommu</span>
				</h3>
				<hr class="wfs-tutorial__line">
				<p style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;">Наш сайт работы для студентов – лучший вариант, чтобы трудоустроиться в области BTL и Event. Среди причин сотрудничать с нами, можно выделить:</p>
				<ul style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;padding-left:20px">
					<li>обширную базу вакансий на десятки различных должностей. При этом все работодатели проверяются, так что вы не попадете на мошенников;</li>
					<li>возможность заполнить свою анкету. Указав точные данные и разместив в резюме фото, вам не нужно будет постоянно просматривать вакансии – работодатели сами свяжутся с вами, если анкета их заинтересует;</li>
					<li>специальное приложение Prommu, которое позволяет получать уведомления и искать подработку прямо с вашего смартфона.</li>
				</ul>	
				<p style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;margin-bottom:30px">С нами вы быстро найдете работу для студентов как по раздаче листовок, так и на любую другую интересующую вас специальность.</p>
				<!--noindex-->
	...
	<div class="row">
		<div class="col-xs-12 wfs__advantages">
			<h2 class="wfs-advantages__title">
				Какой должна быть подработка
				<span class="wfs-advantages__title-reg">для студентов с ежедневной оплатой</span>
			</h2>
			<hr class="wfs-advantages__line">
			<p style="font-family:RobotoCondensedLight,RobotoCondensedRegular,Calibri,Arial,sans-serif;text-align:justify;color:#646464;font-size:18px;margin:0 0 50px">При выборе подходящей занятости среди нескольких вакансий, следует искать предложения, которые соответствуют следующим требованиям:</p>
			<div class="row wfs-advantages__list">
				<div class="col-xs-12 wfs-advantages__item">
					...
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Простота трудоустройства</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Отсутствие диплома и опыта – общая черта большинства студентов. При этом не все работодатели охотно принимают таких сотрудников. Как результат, стоит нацелиться на те должности, для которых не требуются особые навыки и умения (промо-специалисты, мерчендайзеры и пр.)</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico1"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Гибкий рабочий график</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Важно, чтобы занятость не отвлекала от учебы, отдыха и других дел. Особенно выгодно тут выглядит занятость в сфере BTL и Event. Трудоустроиться можно на один или несколько дней, по вечерам, на выходные или праздники. Вы сами выбираете, сколько и когда работать</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico2"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Ежедневная выплата</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Почасовая оплата с выплатой каждый день – самый лучший способ избежать мошенников. Именно такой способ расчета предлагает занятость в области маркетинга. При этом ставка за один час может достигать 500 рублей</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico4"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Интересное времяпрепровождение</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Такое трудоустройство дает возможность получить опыт, развить свои навыки и умения, а также интересно провести время. В ходе проведения промо-мероприятий специалисты участвуют в различных шоу-программах, знакомятся с интересными людьми, общаются. В результате, улучшается презентабельность и умение общаться, что поможет с дальнейшим трудоустройством</p>
					</div>
				</div>
			</div>
		</div>
