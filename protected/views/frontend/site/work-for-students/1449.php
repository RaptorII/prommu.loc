	...
	<div class="container-fluid wfs__content">
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				...
				<p style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;">Если вы студент, то для того, чтобы найти подработку с помощью нашего сайта, необходимо:</p>
				...
				<p style="font-size:18px;color:#ffffff;font-family:Roboto-Regular,Calibri,Arial,sans-serif;margin-bottom:30px">Дополнительно мы рекомендуем вам установить мобильное приложение Prommu. Оно позволит вам искать работу прямо с мобильного устройства. Кроме того, так уведомления о собеседованиях или новых вакансиях будут приходить на ваш смартфон, и вы будете всегда в курсе новых предложений.</p>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__bottom-text">
			<h3 style="text-align:center;font-size:16px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif">Максимально заполненная анкета повышает возможность для студентов найти подработку с ежедневной оплатой</h3>
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif">Чтобы увеличить вероятность приглашения работодателем для работы над проектом, мы рекомендуем вам максимально полно заполнить свою анкету. Работодатели регулярно просматривают нашу базу резюме и часто приглашают кандидатов, даже если те не откликались на вакансии. Заказчики отдают предпочтение тем соискателям, у которых в анкете есть фотография и подробная анкета.</p>
			<p style="font-size:15px;color:#646464;font-family: Roboto-Regular,Calibri,Arial,sans-serif">С нами вы сможете быстро найти хорошую подработку в сфере BTL и Event мероприятий, которую с легкостью можно совмещать с учебой.</p>
		</div>
	</div>
</div>
