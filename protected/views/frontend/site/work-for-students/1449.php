...
<div class="work-for-students__wrapper">
	<div class="wfs-wrapper__title">
		<h1 class="wfs-wrapper__title-h1">
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-orange">Сайт поиска работы</span></span>
			<span class="wfs-wrapper__title-bg">для студентов в Новосибирске</span>
			<span class="wfs-wrapper__title-bg"><span class="wfs-wrapper__title-green">в сфере BTL и Event</span></span>
		</h1>
	</div>
</div>
<div class="container-fluid wfs__content">
	<div class="row">
		...
		<div class="col-xs-12 wfs-prolog__text" style="padding-top:0">
			...
			<p>Под термином BTL подразумевают продвижение товара или бренда без использования традиционных средств массовой информации (печатные издания, наружная реклама, радио, телевизор и т. д.). В BTL-маркетинг входят различные промо-акции и другие схожие мероприятия, которые воздействуют на конкретных потребителей. В последнее время такая реклама пользуется все большей популярностью в силу ее высокой эффективности. Как результат, на рынке труда постоянно растет спрос на промо-специалистов.</p>
		</div>
	</div>
</div>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__vacancies">
			...
			<p style="font-size:15px;color:#646464;">Но на промоутерах перечень должностей в сфере BTL не заканчиваются. На нашем сайте работы для студентов вы увидите такие вакансии:</p>
			...
			<p style="font-size:15px;color:#646464;border-bottom:6px solid #abb837;padding-bottom:45px">Все профессии достаточно разнообразные, многие из них предполагают общение с людьми, а также участие в интересных шоу-программах и других акциях. Таким образом, занятость принесет вам массу положительных впечатлений.</p>
		...
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				<h2 class="wfs-tutorial__title">
					Как искать вакансии работы на лето
					<span class="wfs-tutorial__title-light">для студентов в Новосибирске</span>
				</h2>
				<hr class="wfs-tutorial__line">
				<p style="font-size:18px;color:#ffffff;">Если вы студент, то для того, чтобы найти подработку с помощью нашего сайта, необходимо:</p>
				<ol style="font-size:18px;color:#ffffff;padding-left:20px">
					<li>Зарегистрироваться на портале.</li>
					<li>Максимально заполнить свою анкету.</li>
					<li>Регулярно просматривать вакансии и откликаться на них.</li>
					<li>Ждать приглашения от работодателей.</li>
				</ol>	
				<p style="font-size:18px;color:#ffffff;margin-bottom:30px">Дополнительно мы рекомендуем вам установить мобильное приложение Prommu. Оно позволит вам искать работу прямо с мобильного устройства. Кроме того, так уведомления о собеседованиях или новых вакансиях будут приходить на ваш смартфон, и вы будете всегда в курсе новых предложений.</p>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__advantages">
			<h2 class="wfs-advantages__title">
				Преимущества такой подработки для студентов
				<span class="wfs-advantages__title-reg">в Новосибирске</span>
			</h2>
			<hr class="wfs-advantages__line">
			<p class="wfs-advantages-item__text">Среди причин, почему востребованы вакансии, например, на раздачу листовок для студентов или любые другие похожие вакансии, стоит выделить:</p><br>
			<div class="row wfs-advantages__list">
				<div class="col-xs-12 wfs-advantages__item">
					...
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Удобный график работы</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Такая работаь, как правило, носит непостоянный характер. Работать можно по несколько часов в день, по выходным или в любое другое свободное время. Как результат, ее можно совмещать с отдыхом, учебой и другими занятиями</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico5"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Почасовую оплату</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Деньги выдаются или же перечисляются сразу же после завершения проекта, при этом ставка за час может достигать от 200 до 500 рублей</p>
					</div>
				</div>
				<div class="col-xs-12 wfs-advantages__item">
					<div class="wfs-advantages-item__img ico3"></div>
					<div class="wfs-advantages-item__info">
						<div class="wfs-advantages-item__name">Улучшение навыков</div>
						<hr class="wfs-advantages-item__line">
						<p class="wfs-advantages-item__text">Поскольку в обязанности промо-сотрудников входит общение и консультирование потенциальных клиентов, это существенно улучшает коммуникативные навыки, что пригодится в дальнейшем, независимо от выбранной вами сферы деятельности</p>
					</div>
				</div>
			</div>
			<p class="wfs-advantages-item__text">При этом для трудоустроиться возможно и без опыта работы и высшего образования. Никаких специальных навыков и умений не нужно, так что найти для себя подходящую работу или подработку могут практически все, включая и студентов.</p>
		</div>
	</div>
</div>
<div class="container-fluid wfs__content">
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__bottom-text">
			<h3 style="text-align:center;font-size:16px;color:#646464">Максимально заполненная анкета повышает возможность для студентов найти подработку с ежедневной оплатой</h3>
			<p style="font-size:15px;color:#646464">Чтобы увеличить вероятность приглашения работодателем для работы над проектом, мы рекомендуем вам максимально полно заполнить свою анкету. Работодатели регулярно просматривают нашу базу резюме и часто приглашают кандидатов, даже если те не откликались на вакансии. Заказчики отдают предпочтение тем соискателям, у которых в анкете есть фотография и подробная анкета.</p>
			<p style="font-size:15px;color:#646464">С нами вы сможете быстро найти хорошую подработку в сфере BTL и Event мероприятий, которую с легкостью можно совмещать с учебой.</p>
		</div>
	</div>
</div>
