                      ...
                      <div class='col-xs-12 col-sm-3 col-lg-2'>
                          ...
                          <div class='company-info-wrapp com-rate' style="text-align:center;">
                              <div class="company-info-status">
                                  ...
                                  <div><span class="pos"><?=$val['mdate']?></span></div>
                              </div>
                              <div class="company-info-start">
                                  <div>На сервисе с </div>
                                  <div><span class="pos"><?=$val['crdate']?></span></div>
                              </div>
                          </div>
                      </div>
