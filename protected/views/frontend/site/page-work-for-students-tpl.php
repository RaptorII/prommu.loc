<style type="text/css">
	...
	@media (max-width:500px){
		.wfs__content .wfs__vacancies{padding:50px 15px 35px}
		.wfs-advantages__title{word-wrap:break-word}
		.wfs-wrapper__title-light{font-size:22px;line-height:40px}
		.wfs-wrapper__title-bg{ background: none; display: block; }
		.wfs-wrapper__title-h1{ background-color: rgba(0,0,0,.7); }
		.wfs-wrapper__title-h1>span:nth-child(2),
		.wfs-wrapper__title-h1>span:nth-child(3){
			font-size: 30px;
			line-height: 50px;
		}
	}	
	@media (max-width:350px){
		.wfs-wrapper__title-light{font-size:22px;line-height:36px}
		.wfs-wrapper__title-h1>span:nth-child(2),
		.wfs-wrapper__title-h1>span:nth-child(3){
			font-size: 30px;
			line-height: 44px;
