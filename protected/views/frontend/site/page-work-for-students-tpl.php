...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs-prolog__text">
			<p>Студенческая пора — это не только получение ценных знаний, но и возможность попробовать свои силы в деловой среде, выработать полезные навыки и получить практический опыт. Активная молодежь предпочитает с первых университетских курсов реализовывать свой потенциал и закладывать основу получения стабильного дохода.</p>
			<p>Студенты, ищущие работу, используют любые возможности временного или частичного трудоустройства, чтобы совмещать эту деятельность с учебой. Среди них актуальны различные формы занятости:</p>
		</div>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__vacancies">
			<h3 class="wfs-vacancies__title">
				Работа для студентов в Москве
				<span class="wfs-vacancies__title-light">без опыта</span>
			</h3>
			<hr class="wfs-vacancies__line">
			<p class="wfs-vacancies__text">Схожая черта среди учащихся ВУЗов и других образовательных заведений — отсутствие богатого практического опыта. Поэтому работа для студентов в Москве со свободным графиком популярна в нескольких направлениях. Наш портал Prommu.com предлагает работу для студентов по следующим специальностям:</p>
			...
			<ul class="wfs-vacancies__small-list">
				<li class="wfs-vacancies__li"><span>промоутеры (громкоговорители, раздача листовок, проведение дегустаций);</span></li>
				<li class="wfs-vacancies__li"><span>консультанты (проведение рекламных акций);</span></li>
				<li class="wfs-vacancies__li"><span>аниматоры (презентация компании через прямой контакт с клиентами);</span></li>
				<li class="wfs-vacancies__li"><span>тайные покупатели (проверка качества обслуживания в точках розничной торговли), и прочие специальности в сфере BTL- мероприятий.</span></li>
			</ul>
		...
		<div class="row">
			<div class="col-xs-12 wfs-tutorial">
				<h3 class="wfs-tutorial__title">
					Найти работу на нашем портале
					<span class="wfs-tutorial__title-light">легко</span>
				</h3>
...
<div class="container-fluid wfs__content">
	<div class="row">
		<div class="col-xs-12 wfs__bottom-text"><b>Главное достоинство такой формы трудоустройства</b> — гибкий график и оплата по факту исполнения обязанностей. На нашем сайте представлено множество привлекательных предложений для молодых парней и девушек различных уровней квалификации.<br>Работа для студентов на выходные — возможность использовать свое свободное время для получения дополнительного дохода и новых знаний. На сайте Prommu.com представлено множество привлекательных вакансий, дающих всем желающим шанс временного трудоустройства уже сегодня!
		</div>
	</div>
