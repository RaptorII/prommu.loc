...
<style type="text/css">
    ...
    /* fix size 22.04.2019*/
    #DiContent .psv__table-list{display:flex;flex-direction:row;flex-wrap:wrap;justify-content:flex-start;align-content:stretch;align-items:stretch}#DiContent .page-search-vacancy .psv-table__title{min-height:auto;position:relative;overflow:hidden;flex:1 1 auto}#DiContent .psv__table-item{padding:0 4px 8px}#DiContent .psv__table-item-wrap{position:relative;height:100%;display:flex;flex-direction:column}#DiContent .psv-table__city{display:block;position:relative;z-index:2}#DiContent .psv-table__city:after{content:attr(data-city);display:block;position:absolute;width:100%;height:auto;top:10px;opacity:0;transition:all .2s cubic-bezier(.47,0,.745,.715);background:#fff;margin:-1px 0 0 -5px;padding:0 4px;border:1px solid grey}.psv__table-block{display:flex;flex-direction:column}.psv-table__param-block{flex:1 1 auto}.psv-table__param-block .psv__param{min-height:34px;margin-bottom:0}.psv-table__param-block .psv__param.ico3{min-height:38px;overflow:hidden}.psv-table__param-block .psv__param.ico3:hover{overflow:visible}#DiContent .psv__param.ico3:hover .psv-table__city:after{content:attr(data-city);position:absolute;width:100%;height:auto;top:0;opacity:1;transition:all .2s cubic-bezier(.47,0,.745,.715);z-index:10}
    .psv__checkbox-label:after,
    .psv__radio-label:after{
        display: block;
        position: absolute;
        width: 30px;
        height: 29px;
    ...
    input:checked + .psv__checkbox-label:after,
    input:checked + .psv__radio-label:after{
        content: '\e989';
    ...
    .psv__view-list:after,
    .psv__view-table:after{
        font-family: "PrommuFont";
        content: '';
    }
    .psv__view-list:after{ content: '\e96a'; color: var(--color-grey);}
    .psv__view-table:after{ content: '\e972'; color: var(--color-grey);}
    .psv__view-list.active:after{ content: '\e96a'; color: var(--color-green); }
    .psv__view-table.active:after{ content: '\e972'; color: var(--color-green); }
    .psv__nothing{
        color: #343434;
        font-size: 18px;
    }
    ...
    .psv__param.ico1:before{ content: '\e977'; color: var(--color-l2-grey); }
    .psv__param.ico2:before{ content: '\e98e'; color: var(--color-l2-grey); font-size: 28px; left: 5px; }
    .psv__param.ico3:before{ content: '\e97f'; color: var(--color-l2-grey); font-size: 24px; left: 8px; }
    .psv__param.ico4:before{ content: '\e97b'; color: var(--color-l2-grey); font-size: 18px; left: 11px; }
    .psv__param.ico5:before{ content: '\e96b'; color: var(--color-l2-grey); }
    .psv__param.ico6:before{ content: '\e901'; color: var(--color-l2-grey); }
    .psv__param.ico7:before{ content: '\e900'; color: var(--color-l2-grey); }

    .psv__list-item-premium .psv__param.ico1:before{ content: '\e977'; color: var(--color-green); }
    .psv__list-item-premium .psv__param.ico2:before{ content: '\e98e'; color: var(--color-green); font-size: 28px; left: 5px; }
    .psv__list-item-premium .psv__param.ico3:before{ content: '\e97f'; color: var(--color-green); font-size: 24px; left: 8px; }
    .psv__list-item-premium .psv__param.ico4:before{ content: '\e97b'; color: var(--color-green); font-size: 18px; left: 11px }
    .psv__list-item-premium .psv__param.ico5:before{ content: '\e96b'; color: var(--color-green); }
    .psv__list-item-premium .psv__param.ico6:before{ content: '\e901'; color: var(--color-green); }
    .psv__list-item-premium .psv__param.ico7:before{ content: '\e900'; color: var(--color-green); }

    .psv__table-premium .psv-table__param-block .psv__param:before{ left: 10px; }
    .psv-table__param-block .psv__param:before{ top: 4px; }

    .psv__table-block .psv__param:before{ line-height: 12px; }

    .psv__table-premium .psv__param.ico1:before{ content: '\e977'; color: var(--color-green); }
    .psv__table-premium .psv__param.ico2:before{ content: '\e98e'; color: var(--color-green); font-size: 28px; left: 5px; }
    .psv__table-premium .psv__param.ico3:before{ content: '\e97f'; color: var(--color-green); font-size: 24px; left: 8px; }
    .psv__table-premium .psv__param.ico4:before{ content: '\e97b'; color: var(--color-green); font-size: 18px; left: 11px }
    .psv__table-premium .psv__param.ico5:before{ content: '\e96b'; color: var(--color-green); }
    .psv__table-premium .psv__param.ico6:before{ content: '\e901'; color: var(--color-green); }
    .psv__table-premium .psv__param.ico7:before{ content: '\e900'; color: var(--color-green); }

    .psv-table__title-premium:after{
        content: '\e96e';
        font-family: "PrommuFont";
        font-size: 30px;
    ...
    .psv__list-item-premium .psv-list__title:before{
        content: '\e96e';
        font-family: "PrommuFont";
        font-size: 30px;
        color: var(--color-l-grn);
    ...
    .psv__list-item-premium .psv-list__title:after{
        content: 'ПРЕМИУМ';
        display: block;
        position: absolute;
        top: 10px;
    ...
    #DiContent .page-search-vacancy .psv__header-btn:hover
    #DiContent .page-search-vacancy .psv__header-btn {
        border-radius: 4px;
    }
</style>
<?php
