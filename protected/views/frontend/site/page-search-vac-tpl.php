            ...
            <div class='filter'>
                <div class='filter-label filter-cities clearfix'>
                    ...
                    <div class='filter-content opened'>
                    	<!--noindex-->
                        <select class='psv__select templatingSelect2'  multiple='multiple' name='cities[]' id="vac-srch-cities">
                            <?php if($viData['selected']['city'] || $cityId):?>
                                <?php foreach ($viData['city'] as $key => $val): ?>
                                    <option value='<?= $val['id'] ? $val['id'] : $cityId  ?>' selected><?= $val['name'] ? $val['name'] : $cityName ?></option>
                                <?php endforeach; ?>
                            <?endif;?>
                            <?php foreach ($arCities as $key => $val): ?>
