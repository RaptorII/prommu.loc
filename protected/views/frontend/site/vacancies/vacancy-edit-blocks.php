...
?>
<div class="tmpl">
    <div class="prmu__popup" id="error_remdate">
        <p>Выбранная дата больше даты завершения вакансии.<br>Пожалуйста введите корректную дату или измените дату завершения вакансии в верхней части экрана</p>
    </div>
</div>