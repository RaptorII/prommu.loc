...
<h3>Редактирование соискателя#'.$data['id_user'].'</h3>';
...
echo CHtml::textField('User[email]', $data['email'], array('class'=>'form-control'));
...
echo '<div class="control-group">
      <label class="control-label">О себе</label>
        <div class="controls input-append">';
echo CHtml::textArea('User[aboutme]', $data['aboutme'], array('class'=>'form-control'));
echo '  <span class="add-on"></span>';
echo '</div></div>';
