firebase.initializeApp({
    messagingSenderId: '845704011368'
});
...
function sendNotification(notification) {
    var key = 'AAAAxOfjHmg:APA91bGljNykiRurhAUchhCEnZ6puyL5IrBw0pbIsV9aR0rXI1_gPmkSmpgMgtBtWBezsQtecDSGjBozqQIYskPc5ZmsRKwYwMz91uDkPrQcR_FgXz0mj5L_j5Z2IW7Dm35_JSOFVSoo';
...
function sendTokenToServer(currentToken) {
    $.get( "https://prommu.com/api.firebase/?endpoint=" + currentToken, function( data ) {});
