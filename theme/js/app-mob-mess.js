!function (t, e, i) {
  !function () {
    ...
    n = m, n.prototype = {
      ...
      ru: {
        days: ["Âîñêðåñåíüå", "Ïîíåäåëüíèê", "Âòîðíèê", "Ñðåäà", "×åòâåðã", "Ïÿòíèöà", "Ñóááîòà"],
        daysShort: ["Âîñ", "Ïîí", "Âòî", "Ñðå", "×åò", "Ïÿò", "Ñóá"],
        daysMin: ["Âñ", "Ïí", "Âò", "Ñð", "×ò", "Ïò", "Ñá"],
        months: ["ßíâàðü", "Ôåâðàëü", "Ìàðò", "Àïðåëü", "Ìàé", "Èþíü", "Èþëü", "Àâãóñò", "Ñåíòÿáðü", "Îêòÿáðü", "Íîÿáðü", "Äåêàáðü"],
        monthsShort: ["ßíâ", "Ôåâ", "Ìàð", "Àïð", "Ìàé", "Èþí", "Èþë", "Àâã", "Ñåí", "Îêò", "Íîÿ", "Äåê"],
        today: "Ñåãîäíÿ",
        clear: "Î÷èñòèòü",
