...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var page_company_mess_view_1 = __webpack_require__(3);
	$(document).ready(function () {
	    new page_company_mess_view_1.PageCompanyMessView();
	});
...
/***/ function(module, exports) {
	...
	"use strict";
	var PageCompanyMessView = (function () {
	    function PageCompanyMessView() {
	        this.lastMessId = 0;
	        this.T1NewMess = 0;
	        this.idTheme = 0;
	        var self = this;
	    ...
	    PageCompanyMessView.prototype.onAttachClickFn = function (e, that) {
	        var self = this;
	        var $that = $(that);
	        e.preventDefault();
	    ...
	    PageCompanyMessView.prototype.onPrevMessClickFn = function (e, that, inFirstId) {
	        var self = this;
	        e.preventDefault();
	    ...
	    PageCompanyMessView.prototype.prependFiles = function (props) {
	        var self = this;
	    ...
	    PageCompanyMessView.prototype.setChatSize = function (inProps) {
	    ...
	    return PageCompanyMessView;
	}());
	exports.PageCompanyMessView = PageCompanyMessView;
