...
var AddressEdit = (function () {
  ...
  AddressEdit.prototype.addLocation = function (e) {
    ...
    //
    //      Ввод должности
    AddressEdit.prototype.inputPost = function (e) {
        this.getPosts(e.value, e);
    }
    //      фокус поля должности
    AddressEdit.prototype.focusPost = function (e) {
        let val = $(e).val();
        $(e).val('').val(val);
        this.getPosts(val, e);
    };
    //      запрос списка должностей
    AddressEdit.prototype.getPosts = function (val, e) {
        let self = this,
    ...
    //      Установка должности
    AddressEdit.prototype.checkPost = function (e) {
        let self = this,
            $e = $(e),
