...
CommFuncs = function () {
  ...
  return t.merge = function (t, e) {
    ...
    for (var t = {}, e = window.location.search.substring(1).split("&"), n = 0; n < e.length; n++) {
      var i = e[n].split("=");
      if (void 0 === t[i[0]]) t[i[0]] = decodeURIComponent(i[1]); else if ("string" == typeof t[i[0]]) {
        var o = [t[i[0]], decodeURIComponent(i[1])];
        t[i[0]] = o
      } else t[i[0]].push(decodeURIComponent(i[1]))
    }
    return t
  }, t.inArray = function (t, e, n) {
    void 0 === n && (n = !1);
    var i, o = !1;
    for (i in n = !!n, e) if (n && e[i] === t || !n && e[i] == t) {
      o = !0;
      break
    }
    return o
  ...
  return i.init = function (n) {
    ...
    } else o.animate({maxHeight: i}, 300, function () {
  ...
  return i.open = function (t) {
    ...
    if (null != e.additionalStyle ? o.removeClass().addClass("mw-win " + e.additionalStyle) : o.removeClass().addClass("mw-win"), n.createBtn(e), e && e.getContent) $.get(e.getContent, function (t) {
    ...
    } else e.css({/*margin: "-".concat("" + e.height() / 2, "px 0 0 -", "" + e.outerWidth() / 2, "px"),*/ left: "50%"})
    ...
    if (n.action.active) {
      ...
      if (i.off("click"), i.remove(), $('<div class="button-action"><button>' + n.action.btnTitle + "</button></div>").appendTo(e.winDOM.find(".mw-win")), n.action.onClick) o = n.action.onClick; else var o = function (t) {
        e.onCloseFn(t)
      };
      $("#MWwrapper .button-action").click(o)
    } else $(e.winDOM.find(".button-action")).html("")
  ...
  return t.prototype.bindFiltersFn = function (t) {
    var e = this;
    if ((t = $(t)) && t.length) n = t.find("[data-field-filter]"); else var n = $("[data-field-filter]");
    ...
    for (var a in o) if ("digits" == a) {
      var r = o[a];
      if (t.which < 48 || 57 < t.which) {
        if (r && -1 !== $.inArray(String.fromCharCode(t.which), r.split("")) || -1 !== $.inArray(t.keyCode, [8, 9, 46, 36, 35, 37, 39])) return 1;
        t.preventDefault()
      }
    } else if ("max" == a && n.val().length >= o[a]) {
      if (e.selectionStart != e.selectionEnd) return 1;
      t.preventDefault()
    }
  }, t
  ...
  return t.prototype.FormSubmit = function (t) {
    ...
    return $(e).find("[data-field-check]:not(.nocheck)").each(function () {
      ...
      for (var o in e) r.setOptions(o, e[o]);
      for (var o in e) {
        var a;
        if (-1 < (a = $.inArray(o, r.filters[0]))) {
          var s = r.filters[1][a];
          if (d = r[s]({filterVal: e[o], item: c, itemVal: l})) break
        }
      }
      if (d) return !1
  ...
  return t.prototype.setAjaxParam = function (t, e) {
    ...
    var e = this;
    if (e.options.insertAllow) t = '<input type="text" class="edit"/><a href="#" class="ok" title="Добавить в список"></a>'; else var t = '<input type="text" class="edit noinsert"/>';
    ...
    clearTimeout(i.vT1), i.vT1 = setTimeout(function () {
      ...
      $.get(i.options.ajaxParams.url, t, function (t) {
        for (var e in t = JSON.parse(t), i.ajaxRetData = t, i.options.insertFirst, r.empty(), t) $("<a href='#' class='item'".concat(" data-name='", t[e].name, "' data-id='", t[e].id, "'>", t[e].name, "</a>")).appendTo(r);
    ...
    var n = this, i = $(e);
    if (t.preventDefault(), i.closest(".dropdown-block").find("input").val(i.text()), o = n.findAddedCity(i.text())) o.prop("selected", !0), o.parent().multipleSelect("refresh"); else {
    ...
    return this.selectObj.find("option").each(function () {
      var t = $(this);
      if (t.text().toUpperCase() == e.toUpperCase()) return t
    }), 0
  ...
  return t.prototype.init = function (t) {
    ...
    if (r.uploadInput.files[0]) {
      ...
      e.set("fn", t.attr("name")), e.set("sc", c.props.scope), e.set("meta", CommFuncs.base64Encode(JSON.stringify(r.meta))), e.set("op", "1"), $.ajax({
        ...
        success: function (t) {
          ...
          try {
            if ((t = JSON.parse(t)).error < 0) throw t.ret && console.warn("ret", t.ret), e = t.error, new Error(t.message);
            if (100 == t.error) if (c.files = t.files, r.onAfterUpload && (t = r.onAfterUpload(t)), "images" == t.file.meta.type) {
    ...
    if (t.files[0]) {
      ...
      o.set("fn", e.attr("name")), o.set("sc", n.props.scope), o.set("op", "1"), $.ajax({
        ...
        type: "POST",
        success: function (t) {
          if ((t = JSON.parse(t)).error) n.props.messageBlock && i.find(n.props.messageBlock).text(t.message), t.ret && console.log("ret", t.ret); else {
            n.files = t.files;
    ...
    n.set("id", r), n.set("op", "2"), $.ajax({
      url: o.props.uploadConnector, type: "POST", success: function (t) {
        ...
        try {
          if ((t = JSON.parse(t)).error < 0) throw o.props.messageBlock && s.find(o.props.messageBlock).text(t.message), {
            message: t.message,
            code: t.error
          };
  ...
  return t.prototype.open = function (t) {
    ...
    G_VARS.App.applyRadios("#MWwrapper"), G_VARS.App.applyCounterMemo("#MWwrapper"), $("#MWwrapper #EdName").focus(), $("#MWwrapper form").submit(function (t) {
      ...
      } else $("#MWwrapper .loading").fadeOut(200)
    })
  ...
  return t.prototype.init = function () {
    ...
    if ($(".vacancy.premium .border").each(function () {
      ...
      function u(t) {
        for (var e = $(t).val().split(" "), n = e.length, i = 0; i < n; i++) e[i] = e[i].charAt(0).toUpperCase() + e[i].slice(1).toLowerCase();
        for ($(t).val(e.join(" ")), n = (e = $(t).val().split("-")).length, i = 0; i < n; i++) e[i] = e[i].charAt(0).toUpperCase() + e[i].slice(1).toLowerCase();
        $(t).val(e.join("-"))
      }
      ...
      $(".selectInd").click(function () {
        ...
        u(r);
        var t = r.val(), e = "focus" === o.type ? 1 : 1e3;
    ...
    $(window).on("load resize", function (t) {
      var e = $(window).width(), n = $("#DiEmplSlider"), i = $("#DiEmpl1Slider");

      function o(t) {
        for (var e = $(".page-index .vacancies__item"), n = $(e).find(".vacancies-item__content-title"), i = $(e).find(".vacancies-item__content-middle"), o = [], a = [], s = 0, r = 0, c = e.length; r < c; r++) $(n[r]).css({height: "initial"}), $(i[r]).css({height: "initial"});
        for (r = 0, c = e.length; r < c; r++) {
          var l = n[r].offsetHeight, d = i[r].offsetHeight;
          r && (s = ~~(r / t)), (null == o[s] || l > o[s]) && (o[s] = l), (null == a[s] || d > a[s]) && (a[s] = d)
        }
        for (r = s = 0, c = e.length; r < c; r++) r && (s = ~~(r / t)), $(n[r]).css({height: o[s]}), $(i[r]).css({height: a[s]})
      }
      ...
      if (props = {
        ...
        if (n.hasClass("off") || "load" == t.type) {
          var a = $(".applicants__item").length, s = $(".companies__item").length;
          (e <= 974 && 3 <= a || 974 < e && e <= 1182 && 4 <= a || 1182 < e && 6 <= a) && n.owlCarousel(props), n.removeClass("off"), m = n.data("owlCarousel")
        }
        !i.hasClass("off") && "load" != t.type || ((e <= 974 && 3 <= s || 974 < e && e <= 1182 && 4 <= s || 1182 < e && 6 <= s) && i.owlCarousel(props), i.removeClass("off"), v = i.data("owlCarousel"))
      } else n.hasClass("off") || (void 0 !== m && null != m && m.destroy(), n.addClass("off")), i.hasClass("off") || (void 0 !== v && null != v && v.destroy(), i.addClass("off"));
    ...
    var o = $("#DiLoading");
    if (i) var a = i.offsetLeft ? i.offsetLeft : 0, s = i.align ? i.align : 0;
    if (i && i.pic) t = MainConfig.PATH_PIC + "loading" + i.pic + ".gif"; else var t = MainConfig.PATH_PIC + "loading2.gif";
  ...
  return t.prototype.init = function () {
    ...
    if (1 == $G_PAGE_VIEW) d = $(".table-view"); else var d = $(".list-view");
    G_VARS.App.showLoading(d, 0, {
      ...
      if (t = JSON.parse(t), d.empty(), $("body").animate({scrollTop: 0}, 500), t && 0 < t.length && !t.error) {
        ...
        for (var n in t) {
          var i = t[n];
          if ("length" != n) if (1 == $G_PAGE_VIEW) {
            for (var o in(r = $(".tab-view-tpl").clone()).toggleClass("tab-view-tpl"), 1 == i.ispremium && r.addClass("premium"), a = "", i.city) a = a + i.city[o] + ", ";
            for (var o in a = a.substr(0, a.length - 2), r.find(".city").append(a), a = "", i.post) a = a + i.post[o] + ", ";
            ...
            for (var o in a = a.substr(0, a.length - 2), r.find("h2").text(a + " (" + i.id + ")").attr("href", function (t, e) {
              ...
              return e + a + "<br>"
            }) : r.find(".payment").remove(), a = "", i.city) a = a + i.city[o] + ", ";
            for (var o in a = a.substr(0, a.length - 2), r.find(".city").html(a), a = "", i.metroes) a = a + i.metroes[o] + ", ";
      ...
      } else d.append("<div class='nodata'>Данным условиям нет подходящих вакансий</div>")
    }).always(function () {
      G_VARS.App.hideLoading()
    })
  }, t
  ...
  return __extends(e, t), e.prototype.init = function () {
    ...
    $(".user-info-blocks").matchHeight(
        ...
        $('#content').on('click', '.js-btn-invite', function (t) {
    ...
    if (n) {
      ...
      if (e.triangle && $.extend(s.triangle.bottom, e.triangle.bottom), $.extend(s.triangle, e.triangle), $.extend(s, e), e = s, i.find("span").text(e.content), i.css({
          width: e.width,
          background: e.bgcolor,
          color: e.color,
          fontSize: e.fontSize
        }), o.css({background: e.bgcolor}), "bottom" == e.positon || e.positon, e.posFunc) e.posFunc(t, i); else if ("bottom" == e.positon) a = $("*").is(t) ? t.offset().top : 1, i.css({
    ...
    $.post(MainConfig.AJAX_POST_INVITE, t, function (t) {
      var e = 0;
      try {
        if (100 != t.error) throw t.error < 0 ? new CustomError(t.message, -102, t.error) : new CustomError(o, -101);
      ...
      if (e) {
        ...
        i.html(o), ModalWindow.redraw({content: i})
      }
    }, "json").fail(function () {
      var t = $($("#TplInvSuccess").text());
      t.html(o), ModalWindow.redraw({content: t})
    })
  }, e
...
}(Page), PageCompanyProfileOwn.prototype.onInformationClick = function (t, e) {
  var n = $(".Info").clone();
  ModalWindow.open({
    content: n,
    action: {active: 0},
...
var PageApplicantList = function () {
  ...
  return t.prototype.init = function () {
    ...
    var c = r ? r[0] : 0, t = 0;
    for (var e in this.CBcityMulti.ajaxRetData) if (this.CBcityMulti.ajaxRetData[e].id == c && "1" == this.CBcityMulti.ajaxRetData[e].ismetro) {
      t = 1;
      break
    }
  ...
  return t.prototype.init = function () {
    ...
    G_VARS.App.showLoading(c, 0, {top: 1, pic: 3}), $.post(MainConfig.AJAX_POST_GETEMPLS, n, function (t) {
        ...
        for (var e in t.empls) {
          ...
          if ("length" != e) {
            ...
            for (var a in i.find(".company-logo img").attr("src", function (t, e) {
              return e + o
            }), s1 = "", n.city) s1 = s1 + n.city[a] + ", ";
            for (var a in s1 = s1.substr(0, s1.length - 2), i.find(".city").html(s1), s1 = "", n.metroes) s1 = s1 + n.metroes[a] + ", ";
      ...
      } else c.append("<div class='nodata'>Данным условиям нет подходящих вакансий</div>")
    }).always(function () {
      G_VARS.App.hideLoading()
    })
  }, t
  ...
  return __extends(e, t), e.prototype.init = function () {
    ...
    if (t.preventDefault(), "sms" == i) (o = $(".services-form.sms-form").clone()).toggleClass("services-form tmpl"), ModalWindow.open({
      content: o,
      action: {active: 0},
    ...
    }); else if ("push" == i) (o = $(".services-form.push-form").clone()).toggleClass("services-form tmpl"), $("body").animate({scrollTop: 0}, 500), ModalWindow.open({
      content: o,
      action: {active: 0},
    ...
    } else $.get(MainConfig.AJAX_GET_GETSERVICE, {id: i}, function (t) {
      t = JSON.parse(t);
  ...
  return t.prototype.init = function () {
    ...
    var s = $(e);
    if (t.preventDefault(), 5 == a && !confirm("Подтвредите действие")) return 0;
    $.post(MainConfig.AJAX_POST_SETRESPONSESTATUS, {idres: s.closest(".controls").data("sid"), s: a}, function (t) {
      if (!(t = JSON.parse(t)).error) {
        if (1 == a) s.closest("tr").fadeOut(300, function () {
          $(this).remove()
        }); else if (3 == a) s.closest("tr").fadeOut(300, function () {
          $(this).remove()
        }); else if (4 == a) {
  ...
  return t.prototype.init = function () {
    ...
    if (t.preventDefault(), (3 == n || 5 == n) && !confirm("Подтвредите действие")) return 0;
    $(".content-block").addClass("load"), $.post(MainConfig.AJAX_POST_SETRESPONSESTATUS, {
      idres: $(o).data("sid"),
      s: n
    }, function (t) {
      if (t = JSON.parse(t), $(".content-block").removeClass("load"), t.error) return 0;
  ...
  return t.prototype.init = function () {
    ...
    var i = $(e).closest(".row")[0], o = $(e).closest(".controls")[0];
    if (t.preventDefault(), !confirm("Подтвредите действие")) return 0;
    $(".content-block").addClass("load"), $.post(MainConfig.AJAX_POST_SETRESPONSESTATUS, {
      idres: $(o).data("sid"),
      s: n
    }, function (t) {
...
G_VARS.App = new IndServ, MainConfig.SITE = G_SITE, $(document).ready(function () {
  ...
  }, 1e3), $("body").on("click", ".admin_notifications", function () {
    if ($(this).hasClass("active")) $(".admin_notifications").removeClass("active"), $(".admin_notifications_list").remove(), $(".admin_notifications_veil").remove(); else {
  ...
  //
  // предупреждение, что вакансия платная
  //
  /*$(document).on('click','.popup__paid-vacancy',function(e){
    e.preventDefault();
    var item = $(e.target).hasClass('.popup__paid-vacancy')
          ? e.target
          : $(e.target).closest('.popup__paid-vacancy');
        link = $(item).prop('href'),
