...
var MainConfig = (function () {
    ...
    MainConfig.PAGE_VACANCY = '/vacancy/';
...
var ModalWindow = (function () {
    function ModalWindow(props) {
        ...
        $('<div class="mw-win"><div class="loading"><i></i></div><a href="#" class="mw-close"><i></i></a><div class="header-block"></div><div class="mw-content"></div></div>').appendTo('#MWwrapper');
    ...
    ModalWindow.prototype.onMoveCenter = function (inProps) {
        ...
        if (self.props.position == 'absolute') {
            ...
            if ($(window).outerHeight() < winContWrapp.outerHeight())
                top = 0;
            winContWrapp.css({ top: top, margin: "".concat('20px 10px 20px -', '' + ((winContWrapp.outerWidth()) / 2 - 10), 'px'), left: "50%", position: 'absolute' });
        }
        else {
...
$(document).ready(function () {
    ...
    if ((G_PAGE == 'profile' || G_PAGE == 'ankety'))
